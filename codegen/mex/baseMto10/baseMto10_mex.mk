...
MAKEFILE = baseMto10_mex.mk

include baseMto10_mex.mki
...
SRC_FILES =  \
	...
	_coder_baseMto10_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = baseMto10_mex
...
SYS_INCLUDE += -I"$(START_DIR)\codegen\mex\baseMto10"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\baseMto10/%.c
	$(CC) -Fo"$@" $(CFLAGS) "$<"
