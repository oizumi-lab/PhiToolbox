START_DIR = C:\Users\oizumi\DOCUME~1\GitHub\PHITOO~1

MATLAB_ROOT = C:\PROGRA~1\MATLAB\R2017b
MAKEFILE = base10toM_mex.mk

include base10toM_mex.mki
...
SRC_FILES =  \
	...
	_coder_base10toM_mex.c \
	base10toM_emxutil.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = base10toM_mex
...
SYS_INCLUDE += -I"$(START_DIR)\codegen\mex\base10toM"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\base10toM/%.c
	$(CC) -Fo"$@" $(CFLAGS) "$<"
